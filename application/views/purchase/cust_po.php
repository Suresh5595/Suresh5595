    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-6">
                <div class="card">
                    <div class="header">
                        <h2 style="background-color: #1cc3d2; padding: 10px;"><strong style="color: white">Customer PO </strong>Info</small> </h2>
                    </div>
                    <div class="body">
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="header">
                        <h2 style="background-color: #1cc3d2; padding: 10px;"><strong style="color: white">Customer </strong>Info</small> </h2>
                    </div>
                   <div class="body">
                        <div id="customer">
                            <div class="row clearfix">
                                <div class="col-lg-6">
                                    <input type="radio" name="customer" checked="checked" value="existing"  />
                            ...
                            <div class="row clearfix">
                                <div class="col-lg-12">
                                    ...
                                    <div id="new" class="desc" style="padding-top: 15px; padding-bottom: 15px;">
                                        <button  class="btn btn-primary btn-round" id="myBtn" data-toggle="modal" data-target="#myModal">Click here to add new Customer</button>
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                    ...
                    <div class="body">
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label>Due on</label>
                                    <input type="text" class="form-control" placeholder="Due on">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label>Per</label>
                                    <input type="text" class="form-control" placeholder="Per">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
    ...
    <div class="modal-dialog" style="margin-left: 150px; max-width: 100%; margin: 0;">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #1cc3d2;">
                ...
                <h4 class="modal-title" id="myModalLabel" style="margin-top: 5px !important;">Add New Customer</h4>
            </div>
