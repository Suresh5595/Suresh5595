    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-6">
                <div class="card">
                    <div class="header">
                        <h2 style="background-color: #1cc3d2; padding: 10px;"><strong style="color: white">Purchase </strong>Info</small> </h2>
                    </div>
                    <div class="body">
                    ...
                    <div class="body">
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label>MRP</label>
                                    <input type="text" class="form-control" placeholder="MRP" readonly>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label>Taxable</label>
                                    <input type="text" class="form-control" placeholder="Taxable" readonly>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="GST Amount" readonly>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Item Total" readonly>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label>Net Total</label>
                                    <input type="text" class="form-control" placeholder="Net Total" readonly>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                            ...
                            <div class="col-lg-12">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>Freight</label>
                                            <input type="text" class="form-control" placeholder="Freight" readonly>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>Taxable</label>
                                            <input type="text" class="form-control" placeholder=" Taxable">
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Grand Total" readonly>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>Discount</label>
                                            <input type="text" class="form-control" placeholder="Discount" readonly>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <label>Notes</label>
                                            <input type="text" class="form-control" placeholder="Notes" readonly>
                                        </div>
                                    </div>
                                </div>
                                    <hr>
